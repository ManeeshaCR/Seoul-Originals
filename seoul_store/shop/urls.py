...
urlpatterns = [
    ...
    path('category/', views.all_categories_products, name='all_categories_products'),
    path('category/<slug:slug>/', views.category_view, name='category'),
    path('checkout/', views.checkout, name='checkout'),
    path('success/<int:order_id>/', views.success, name='success'),
    path('product/<slug:slug>/', views.product_detail, name='product_detail'),
    path('tag/<str:tag>/', views.tag_products, name='tag_products'),
    ...
    path('return/pick/<int:return_id>/', views.mark_as_picked, name='mark_as_picked'),
    path('price/', views.price_filter, name='price_filter'),
]